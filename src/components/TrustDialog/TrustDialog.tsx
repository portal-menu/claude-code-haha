...
export function TrustDialog(t0) {
  ...
  if ($[20] === Symbol.for("react.memo_cache_sentinel")) {
    ...
    t17 = <Text>快速安全检查：这是您创建的项目还是您信任的项目？（如您自己的代码、知名开源项目或团队工作）。如果不是，请先花点时间查看此文件夹中的内容。</Text>;
    t18 = <Text>Open Claude Code 中文汉化版 将能够在此处读取、编辑和执行文件。</Text>;
    $[20] = t16;
    $[21] = t17;
    $[22] = t18;
  } else {
  ...
  if ($[23] === Symbol.for("react.memo_cache_sentinel")) {
    t19 = <Text dimColor={true}><Link url="https://code.claude.com/docs/zh/security">安全指南</Link></Text>;
    $[23] = t19;
  } else {
    t19 = $[23];
  }
  ...
  if ($[27] !== exitState.keyName || $[28] !== exitState.pending) {
    t22 = <Text dimColor={true}>{exitState.pending ? <>再次按 {exitState.keyName} 退出</> : <>按回车键确认 · Esc 取消</>}</Text>;
